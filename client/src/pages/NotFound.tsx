  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background">
      <Card className="w-full max-w-lg mx-4 shadow-lg border border-border bg-card">
        <CardContent className="pt-8 pb-8 text-center text-card-foreground">
          ...
          >
            <Button
              ...
              className="gold-bg text-black hover:bg-[#1d4ed8] px-6 py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg font-semibold"
            >
