...
- **Filename:** `valentines-menu.jpeg` (used on Events page and in Saint-Valentin emails)
- **Location:** this folder (`client/public/`) so it is deployed and available at `https://www.testrestaurant.com/valentines-menu.jpeg`
